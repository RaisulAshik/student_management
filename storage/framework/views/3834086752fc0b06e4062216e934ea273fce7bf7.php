   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Add Offline Student Payment</h2>
							</header>
							<div class="panel-body">
								<form class="" action="<?php echo e(action('AdminOfflineStudentController@create_offline_payment_installment',$payment->id)); ?>" method="post" id="formIns">
									<?php echo csrf_field(); ?>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="number" name="" class="form-control" id="total_amount" readonly="true" value="<?php echo e($payment->total_amount); ?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="number" name="" class="form-control" id="total_amount" readonly="true" value="<?php echo e($payment->paid_amount); ?>">
										</div>
									</div>
										...
										<div class="form-group">
										    ...
										    <div class="col-md-6">
												<div class="input-group">
													...
													<input type="text" name="next_payment_date" data-plugin-datepicker class="form-control" id="next_payment_date" value="<?php echo e($student->next_payment_date); ?>">
													</div>
											</div>
										 </div>	
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegroover/public_html/student_management/resources/views/admin/offline/addOfflinePaymentInstallment.blade.php ENDPATH**/ ?>