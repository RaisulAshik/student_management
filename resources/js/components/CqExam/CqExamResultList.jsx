...
class CqExamResultList extends Component {
    constructor(props) {
        if (
            ...
            axios
                ...
                .then(res => {
                    ...
                    if (res.data.profile === null) {
                        ...
                        ExamQus.getCqResultList(data).then(res => {
                            this.setState({ cqExamList: res.data });
                        });
                    }
                });
        }
    ...
    getTheClassData() {
        return (
            <>
                {this.state.cqExamList.length === 0 ? (
                    <NoDataFound noDataFoundMessage="No Result Available yet" />
                        ...
                        <div className="horizontal-scroll table-responsive">
                            <table className="table table-hover">
                                ...
                                <tbody>
                                    {this.state.cqExamList.map(data => {
                                        return (
                                            <tr key={data.id}>
                                                <td>{data.name}</td>
                            ...
                            <div className="col-md-9">
                                ...
                                <div className="app-background mb-3">
                                    ...
                                    <p className="text-center">
                                        Here you can see all of your CQ Exam Result List.
                                    </p>
                                </div>
