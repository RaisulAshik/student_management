...
<?php $__env->startSection('content'); ?>
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Add MCQ Exam</h2>
							</header>
							<div class="panel-body">
								<form class="" action="<?php echo e(action('AdminMCQExamController@create_mcq_exam')); ?>" method="post">
									<?php echo csrf_field(); ?>
										...
										<label class="col-md-2 control-label">Exam Date</label>
										    <div class="col-md-6">
												<div class="input-group">
													...
													<input type="text" name="exam_date" id="exam_date" data-plugin-datepicker class="form-control">
													</div>
											</div>
									</div>
									 <div class="form-group">
										<label class="col-md-2 control-label">Exam Time</label>
										    <div class="col-md-3">
												<div class="input-group">
													...
													<input type="text" name="start_time" data-plugin-timepicker class="form-control">
												</div>
											</div>
											<div class="col-md-3">
												<div class="input-group">
													...
													<input type="text" name="end_time" data-plugin-timepicker class="form-control">
												</div>
											</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="number" step="0.01" name="total_exam_duration" class="form-control" id="inputDefault">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Exam Marks</label>
										<div class="col-md-6">
											<input type="number" step="0.01" name="total_exam_marks" class="form-control" id="inputDefault">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Passing Percentage(In %)</label>
										<div class="col-md-6">
											<input type="number" step="0.01" name="passing_percentage" class="form-control" id="inputDefault">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Time Per Question(In Seconds)</label>
										<div class="col-md-6">
											<input type="number" step="0.01" name="duration_per_question" class="form-control" id="inputDefault">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Mark Per Question</label>
										<div class="col-md-6">
											<input type="number" step="0.01" name="mark_per_question" class="form-control" id="inputDefault">
										</div>
									</div>
									<div class="form-group">
										<div class="checkbox">
										    ...
										    <div class="col-md-6">
											  <input type="checkbox" id="negative" name="negative_marking" value="1">
										    </div>
										</div>
									</div>
									...
									<div class="form-group" id="negative_mark">
										...
										<div class="col-md-6">
											<input type="number" step="0.01" name="negative_mark_per_question" class="form-control" id="inputDefault">
										</div>
									</div>

									<button type="submit" class="mb-xs mt-xs mr-xs btn btn-success pull-right">Add Exam</button>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegroover/public_html/student_management/resources/views/admin/mcqExam/mcqExamAdd.blade.php ENDPATH**/ ?>