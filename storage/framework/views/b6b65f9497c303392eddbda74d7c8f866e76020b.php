   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Add SMS</h2>
							</header>
							<div class="panel-body">
								<form class="" action="<?php echo e(action('AdminSMSController@store')); ?>" method="post">
									<?php echo csrf_field(); ?>
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												<div class="checkbox">
												    ...
												    <div class="col-md-6">
													  <input type="checkbox" id="negative" name="all_student" value="1">
												    </div>
												</div>
											</div>
									...
									<button type="submit" class="mb-xs mt-xs mr-xs btn btn-success">Send</button>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegroover/public_html/student_management/resources/views/admin/sms/addSMS.blade.php ENDPATH**/ ?>