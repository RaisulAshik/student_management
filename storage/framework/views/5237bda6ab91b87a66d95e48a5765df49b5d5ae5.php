   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Add Live Classes</h2>
							</header>
							<div class="panel-body">
								<form class="" action="<?php echo e(action('ZoomClass@create')); ?>" method="post">
									<?php echo csrf_field(); ?>
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Topic</label>
											<div class="col-md-6">
												<input type="text" class="form-control" name="topic" id="inputDefault">
											</div>
									</div> 
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="number" name="duration" class="form-control" id="inputDefault">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<select class="form-control mb-md" name="zoom_api" >
												<option value="0" selected="true" disabled="true">Select API</option>
												<?php $__currentLoopData = $zoomapis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zoomapi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($zoomapi->id); ?>"><?php echo e($zoomapi->zoom_api_name); ?></option>  
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											</select>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegigz/public_html/student_management/resources/views/admin/liveClass/addClass.blade.php ENDPATH**/ ?>