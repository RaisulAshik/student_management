...
class AuthController extends Controller
{
    ...
    public function registration(Request $request){
        ...
        //POST Method example
                ...
                $number = $request->phone;
                $message ='Your Registration ID:'.$registration_id.' Password: '.$password;
    ...
    public function forgotpassword(Request $request)
    {
        ...
        if($student){
            ...
            //   $sendstatus = $p[0];
                ...
                $senderid = "8809617614336";
                $number = $phone;
                $message ='Hello '.$student->first_name.' '.$student->last_name.' Your Registration ID: '.$student->registration_id.' Password: '.$password;
