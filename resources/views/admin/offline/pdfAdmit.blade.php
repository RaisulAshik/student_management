...
@endphp
	...
	@if($student_profile)
	    @if($student_profile->image == null)
			<div class="student-photo">
	            <div class="empty-image">Student's Photo</div>
	        </div>
		@elseif($student_profile->image != null)
			<div class="student-photo">
	            <div class="empty-image"><img style="height: 150px; width: 150px;" src='{{ asset('studentImage/'.$student_profile->image) }}'></div>
	        </div>
        @endif
	@else
	<div class="student-photo">
