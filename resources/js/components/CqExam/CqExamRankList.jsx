...
class CqExamRankList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            Rank: []
            ...
            axios
                ...
                .then(res => {
                    ...
                    if (res.data.profile === null) {
                        ...
                        ExamQus.getCqRankList(data).then(res => {
                    ...
                    <NoDataFound noDataFoundMessage="No Result Available yet" />
                        ...
                        <div className="">
                            <div className="text-center mb-2">
                                <div className="">
                                    <b>Exam Title : {this.props.location.state.examTitle}</b>
                                </div>
                                <div className="">
                                    <b>Class : {this.props.location.state.class}</b>
                                </div>
                                <div className="">
                                    <b>Subject Name : {this.props.location.state.subjectName}</b>
                                </div>
                                <div className="">
                                    <b>Exam Date : {this.getTheDay(this.props.location.state.examDate)}</b>
                                </div>
                            </div>
