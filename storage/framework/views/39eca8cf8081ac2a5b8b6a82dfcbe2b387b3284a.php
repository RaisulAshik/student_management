...
<?php $__env->startSection('content'); ?>
					...
					<section class="panel">
							...
							<div class="panel-body">
								<form class="" action="<?php echo e(action('AdminExamController@create_exam')); ?>" method="post" enctype="multipart/form-data">
									<?php echo csrf_field(); ?>
									...
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Highest Marks</label>
										<div class="col-md-6">
									...
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Satisfactory Mark</label>
										<div class="col-md-6">
											<input type="number" step="0.01" name="satisfactory_mark" class="form-control" id="inputDefault">
										</div>
									</div>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegroover/public_html/student_management/resources/views/admin/exam/examAdd.blade.php ENDPATH**/ ?>