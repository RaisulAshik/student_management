   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Add Message</h2>
							</header>
							<div class="panel-body">
								<form class="" action="<?php echo e(action('AdminMessageController@store')); ?>" method="post">
									<?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegigz/public_html/student_management/resources/views/admin/message/addMessage.blade.php ENDPATH**/ ?>