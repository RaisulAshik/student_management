   ...
   <header class="page-header">
					...
					<section class="panel">
							...
							<div class="panel-body">
								<form class="" action="<?php echo e(action('AdminController@store')); ?>" method="post">
									<?php echo csrf_field(); ?>
									...
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Email</label>
											<div class="col-md-6">
												<input type="email" class="form-control" name="email" id="inputDefault">
											</div>
									</div>
									<div class="form-group">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegigz/public_html/student_management/resources/views/admin/admin/addAdmin.blade.php ENDPATH**/ ?>