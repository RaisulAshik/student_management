...
<body>
    ...
    <table id="invoice" border="2" cellspacing="0" cellpadding="0"
        ...
        <tbody>
            <?php $__currentLoopData = $student_payment_installments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $installment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>

                    <td class="table-data">
                        <?php echo e($installment->payment_date); ?>
...
<?php /**PATH /home/codegroover/public_html/student_management/resources/views/admin/offline/pdfPaymentInvoice.blade.php ENDPATH**/ ?>