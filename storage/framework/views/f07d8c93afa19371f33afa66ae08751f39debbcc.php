								...
								<table class="table table-bordered table-striped mb-none" id="">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td><?php echo e($student->total_exam_marks); ?></td>
											<td><?php echo e($student->score); ?></td>
                                           
												
											<td>
												<a class="mb-xs mt-xs mr-xs btn btn-primary btn-xs" href="<?php echo e(url('admin/mcq_student_result/'.$student->exam_id.'/student/'.$student->student_id)); ?>" >View Result</a>
											</td>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegigz/public_html/student_management/resources/views/admin/mcqExamResult/studentList.blade.php ENDPATH**/ ?>