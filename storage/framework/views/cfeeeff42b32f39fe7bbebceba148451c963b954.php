   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<a class="" href="<?php echo e(action('AdminOfflineStudentController@add_student')); ?>"><i class="fa fa-plus"></i> Add Student
								</a>
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td style="">
												...
												<a href="<?php echo e(route('admin.offline_student_admit_pdf',$student->id)); ?>" class="mb-xs mt-xs mr-xs btn btn-sm btn-danger" >Admit Card</a>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegroover/public_html/student_management/resources/views/admin/offline/studentList.blade.php ENDPATH**/ ?>