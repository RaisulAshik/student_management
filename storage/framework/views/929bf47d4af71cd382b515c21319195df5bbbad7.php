   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Add Offline Students</h2>
							</header>
							<div class="panel-body">
								<form class="" action="<?php echo e(action('AdminOfflineStudentController@create_student')); ?>" method="post">
									<?php echo csrf_field(); ?>
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">First Name</label>
											<div class="col-md-6">
												<input type="text" class="form-control" name="first_name" id="inputDefault">
											</div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Last Name</label>
											<div class="col-md-6">
												<input type="text" class="form-control" name="last_name" id="inputDefault">
											</div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Mobile Number</label>
										<div class="col-md-6">
											<input type="number" name="phone" class="form-control" id="inputDefault">
										</div>
									</div>
									<div class="form-group">
				...
				$.ajax({
					...
					for(var i=0;i<data.length;i++){
					    ...
					    op2+=`<div class="checkbox">
								<label>
									<input class="subject" type="checkbox" name="subject_id[]" value="${data[i].id}" data-amount="${data[i].amount}">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\student_management\resources\views/admin/offline/addStudent.blade.php ENDPATH**/ ?>