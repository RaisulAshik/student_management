   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<a class="" href="<?php echo e(action('AdminSMSController@create')); ?>"><i class="fa fa-plus"></i> Add
								</a>
								</div>
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td>
												...
												<form method="post" action="<?php echo e(route('sms.destroy',$message->id)); ?>"  style="display: inline">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegroover/public_html/student_management/resources/views/admin/sms/smsList.blade.php ENDPATH**/ ?>