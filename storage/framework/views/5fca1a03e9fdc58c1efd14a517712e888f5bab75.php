   ...
   <header class="page-header">
					...
					<section class="panel">
							...
							<div class="panel-body">
								<form class="" action="<?php echo e(action('SubjectController@store')); ?>" method="post">
									<?php echo csrf_field(); ?>
									...
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputSuccess">Teachers</label>
										<div class="col-md-6">
											<select class="form-control mb-md" name="admin_id" id="admin_id">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\student_management\resources\views/admin/subject/addSubject.blade.php ENDPATH**/ ?>