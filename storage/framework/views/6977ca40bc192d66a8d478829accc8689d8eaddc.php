   ...
   <header class="page-header">
					...
					<section class="panel">
							...
							<div class="panel-body">
								<form class="" action="<?php echo e(action('BatchController@update',$batch->id)); ?>" method="post">
									<?php echo csrf_field(); ?>
									<input type="hidden" name="_method" value="PUT">
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Name</label>
											<div class="col-md-6">
												<input type="text" class="form-control" name="name" id="inputDefault" value="<?php echo e($batch->name); ?>">
											</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<select class="form-control mb-md" name="branch_id" id="branch">
												<option value="<?php echo e($batch->branch_id); ?>" selected="true"><?php echo e($batch->branch->name); ?></option>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<select class="form-control mb-md" name="class_id" id="class">
												<option value="<?php echo e($batch->class_id); ?>" selected="true"><?php echo e($batch->classname->name); ?></option>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" name="time" class="form-control" id="inputDefault" value="<?php echo e($batch->time); ?>" >
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="number" name="max_student_number" class="form-control" id="inputDefault" value="<?php echo e($batch->max_student_number); ?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<select class="form-control mb-md" name="student_type" id="student_type">
												<option value="0" <?php echo e($batch->student_type == 0 ? 'selected' : ''); ?>>Offline</option>
												<option value="1" <?php echo e($batch->student_type == 1 ? 'selected' : ''); ?>>Online</option>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<select class="form-control mb-md" name="status" id="type">
												<option value="0" <?php echo e($batch->status == 0 ? 'selected' : ''); ?>>Inactive</option>
												<option value="1" <?php echo e($batch->status == 1 ? 'selected' : ''); ?>>Active</option>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegroover/public_html/student_management/resources/views/admin/batch/editBatch.blade.php ENDPATH**/ ?>