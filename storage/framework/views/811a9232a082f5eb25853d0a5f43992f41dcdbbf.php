									    ...
									    <label class="col-md-2 control-label">Start Date</label>
										    <div class="col-md-6">
												<div class="input-group">
													...
													<input type="text" name="start_date" id=""  data-plugin-datepicker class="form-control"value="<?php echo e($request_start_date); ?>">
												</div>
											</div>
									</div>
									 <div class="form-group">
									    <label class="col-md-2 control-label">End Date</label>
										    <div class="col-md-6">
												<div class="input-group">
													...
													<input type="text" name="end_date" id=""  data-plugin-datepicker class="form-control"value="<?php echo e($request_end_date); ?>">
												</div>
											</div>
									</div> 
					...
					<section class="panel">
							<header class="panel-heading">
								<div class="panel-actions">
									<form method="get" action="<?php echo e(action('AdminExamController@individual_std_exam_result_search_pdf',request()->id)); ?>"  style="display: inline">
										<?php echo csrf_field(); ?>
										<input type="hidden" name="request_start_date" value="<?php echo e($request_start_date); ?>">
										<input type="hidden" name="request_end_date" value="<?php echo e($request_end_date); ?>">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegroover/public_html/student_management/resources/views/admin/exam/studentResultSearch.blade.php ENDPATH**/ ?>