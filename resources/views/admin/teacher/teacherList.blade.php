								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td>{{$teacher->expectedAmount}}</td>
											<td>{{floor($teacher->afterDiscountAmount)}}</td>
											<td>{{floor($teacher->totalPaid)}}</td>
											<td>{{floor($teacher->dueAmount)}}</td>
											<td>
												<a href="{{ route('teachers.edit',$teacher->id) }}" class="mb-xs mt-xs mr-xs btn btn-primary" >Edit</a>
												<a href="{{ route('teachers.paymentInstallmentList',$teacher->id) }}" class="mb-xs mt-xs mr-xs btn btn-primary" >Payments</a>
