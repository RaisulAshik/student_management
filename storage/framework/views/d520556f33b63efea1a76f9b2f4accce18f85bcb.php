						...
						<div class="nano-content">
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-main">
									...
									<?php endif; ?>
									<!-- Student Homework -->
									<?php if($admin->hasPermissionTo('view-homework', 'admin')): ?>
									<li class="nav-active">
									...
									<?php endif; ?>
									<?php if($admin->hasPermissionTo('manage-zoom-classes', 'admin')): ?>
									<li class="nav-parent">
										<a>
									...
									<?php endif; ?>
									<?php if($admin->hasPermissionTo('manage-mcq-exams', 'admin') || $admin->hasPermissionTo('view-mcq-results', 'admin')): ?>
									<li class="nav-parent">
										<a>
									...
									<?php endif; ?>
									<?php if($admin->hasPermissionTo('manage-cq-exams', 'admin') || $admin->hasPermissionTo('view-cq-results', 'admin')): ?>
									<li class="nav-parent">
										<a>
										...
										<?php endif; ?>
										<?php if($admin->hasPermissionTo('view-cq-results', 'admin')): ?>
										<ul class="nav nav-children">
											<li>
...
</html><?php /**PATH C:\laragon\www\student_management\resources\views/admin/layout/master.blade.php ENDPATH**/ ?>