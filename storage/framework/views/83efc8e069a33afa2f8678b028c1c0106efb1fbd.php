   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<form method="get" action="<?php echo e(action('ExpenseController@expensePdfSearch')); ?>"  style="display: inline">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegroover/public_html/student_management/resources/views/admin/expense/expenseSearch.blade.php ENDPATH**/ ?>