   ...
   <header class="page-header">
					...
					<section class="panel">
							...
							<div class="panel-body">
								<form class="" action="<?php echo e(action('ClassController@store')); ?>" method="post">
									<?php echo csrf_field(); ?>
									...
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">HSC Year</label>
											<div class="col-md-6">
												<input type="text" class="form-control" name="year" id="inputDefault">
											</div>
									</div>
									<div class="form-group">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegroover/public_html/student_management/resources/views/admin/class/addClass.blade.php ENDPATH**/ ?>