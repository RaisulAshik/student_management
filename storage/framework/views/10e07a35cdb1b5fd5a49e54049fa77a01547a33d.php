			                    ...
			                    <div class="col-md-4">
			                        <div class="profile-img">
			                        	<?php if($student->image == null): ?>
										    <img src="<?php echo e(asset('images/person4.jpg')); ?>" alt=""/>
			                ...
			                <div class="row">
			                    <div class="col-md-4">
			                        <div style="font-weight: 900" class="profile-work text-center">
			                            <h5>Name: <?php echo e($student->first_name); ?> <?php echo e($student->last_name); ?></h5>
			                            <h5>Registration Id: <?php echo e($student->registration_id); ?></h5>
			                       ...
			                       <div style="margin-top: -150px" class="tab-content profile-tab" id="myTabContent"> 
				                       ...
				                       <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
	                                        ...
	                                        <div class="row">
	                                            ...
	                                            <div class="col-md-6">
	                                                <p><?php echo e($student->college); ?></p>
	                                            </div>
	                                        </div>
	                                        <div class="row">
	                                            <div class="col-md-6">
	                                        ...
	                                        <div class="row">
	                                            ...
	                                            <div class="col-md-6">
	                                                <p><?php echo e($student->branch->name); ?></p>
	                                            </div>
	                                        </div>
	                                        <div class="row">
	                                            <div class="col-md-6">
	                                        ...
	                                        <div class="row">
	                                            ...
	                                            <div class="col-md-6">
	                                                <p><?php echo e($student->date_of_addmission); ?></p>
	                                            </div>
	                                        </div>
	                                    ...
	                                    <div class="tab-pane" id="profile" role="tabpanel" aria-labelledby="home-tab">
	                                        <div class="row">
	                                            ...
	                                            <div class="col-md-6">
	                                                <p><?php echo e(($student->profile) ? $student->profile->date_of_birth: ''); ?></p>
	                                            </div>
	                                        </div>
	                                        <div class="row">
	                                            <div class="col-md-6">
	                                            ...
	                                            <div class="col-md-6">
	                                                <p><?php echo e(($student->profile) ? $student->profile->gender: ''); ?></p>
	                                            </div>
	                                        </div>
	                                        <div class="row">
	                                            <div class="col-md-6">
	                                            ...
	                                            <div class="col-md-6">
	                                                <p><?php echo e(($student->profile) ? $student->profile->zoom_id: ''); ?></p>
	                                            </div>
	                                        </div>
	                                        <div class="row">
	                                            <div class="col-md-6">
	                                            ...
	                                            <div class="col-md-6">
	                                                <p><?php echo e(($student->profile) ? $student->profile->institution: ''); ?></p>
	                                            </div>
	                                        </div>
	                                        <div class="row">
	                                            <div class="col-md-6">
	                                            ...
	                                            <div class="col-md-6">
	                                                <p><?php echo e(($student->profile) ? $student->profile->father_name: ''); ?></p>
	                                            </div>
	                                        </div>
	                                        <div class="row">
	                                            <div class="col-md-6">
	                                            ...
	                                            <div class="col-md-6">
	                                                <p><?php echo e(($student->profile) ? $student->profile->father_phone: ''); ?></p>
	                                            </div>
	                                        </div>
	                                        <div class="row">
	                                            <div class="col-md-6">
	                                            ...
	                                            <div class="col-md-6">
	                                                <p><?php echo e(($student->profile) ? $student->profile->mother_name: ''); ?></p>
	                                            </div>
	                                        </div>
	                                        <div class="row">
	                                            <div class="col-md-6">
	                                            ...
	                                            <div class="col-md-6">
	                                                <p><?php echo e(($student->profile) ? $student->profile->mother_phone: ''); ?></p>
	                                            </div>
	                                        </div>
	                                        <div class="row">
	                                            <div class="col-md-6">
	                                            ...
	                                            <div class="col-md-6">
	                                                <p><?php echo e(($student->profile) ? $student->profile->present_address: ''); ?></p>
	                                            </div>
	                                        </div>
	                                        <div class="row">
	                                            <div class="col-md-6">
	                                            ...
	                                            <div class="col-md-6">
	                                                <p><?php echo e(($student->profile) ? $student->profile->permanent_address: ''); ?></p>
	                                            </div>
	                                        </div>
	                                        <div class="row">
	                                            <div class="col-md-6">
	                                            ...
	                                            <div class="col-md-6">
	                                                <p><?php echo e(($student->profile) ? $student->profile->gaurdian_name: ''); ?></p>
	                                            </div>
	                                        </div>
	                                        <div class="row">
	                                            <div class="col-md-6">
	                                            ...
	                                            <div class="col-md-6">
	                                                <p><?php echo e(($student->profile) ? $student->profile->gaurdian_relation: ''); ?></p>
	                                            </div>
	                                        </div>
	                                        <div class="row">
	                                            <div class="col-md-6">
	                                            ...
	                                            <div class="col-md-6">
	                                                <p><?php echo e(($student->profile) ? $student->profile->gaurdian_phone: ''); ?></p>
	                                            </div>
	                                        </div>
	                                        <div class="row">
	                                            <div class="col-md-6">
	                                            ...
	                                            <div class="col-md-6">
	                                                <p><?php echo e(($student->profile) ? $student->profile->gaurdian_address: ''); ?></p>
	                                            </div>
	                                        </div>
	                                    ...
	                                    <div class="tab-pane" id="subject" role="tabpanel" aria-labelledby="home-tab">
	                                        ...
	                                        <div class="row">
	                                            <div class="col-md-6">
	                                                <label><?php echo e($subject->subject->classname->name); ?> - <?php echo e($subject->subject->name); ?></label>
	                                            </div>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegigz/public_html/student_management/resources/views/admin/student/viewStudent.blade.php ENDPATH**/ ?>