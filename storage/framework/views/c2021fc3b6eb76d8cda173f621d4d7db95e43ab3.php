   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Add Due SMS</h2>
							</header>
							<div class="panel-body">
								<form class="" action="<?php echo e(action('AdminDueSMSController@store')); ?>" method="post">
									<?php echo csrf_field(); ?>
									<div class="row">
										<div class="col-md-12">
									...
									<button type="submit" class="mb-xs mt-xs mr-xs btn btn-success">Send Due SMS</button>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegigz/public_html/student_management/resources/views/admin/dueSms/addSMS.blade.php ENDPATH**/ ?>