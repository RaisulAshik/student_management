...
@endphp
        ...
        <tbody>
            @foreach($expenses as $expense)
                <tr>
                    ...
                    <td class="table-data">
                        {{($expense->expense_category_id != null) ? $expense->expenseCategory->name:'' }}
                    </td>
                    <td class="table-data">
                        {{ $expense->branch->name }}
                    </td>
    ...
    <table id="invoice" border="2" cellspacing="0" cellpadding="0" style="margin-bottom:20px" >

        <thead>
            <tr>

                <th style="text-align: center;width:88%;"
                    style="background-color:white; color:black;font-size:8px;background-color:lightgrey;padding:10px 10px;">
                    Group Name
                </th>
        ...
        <tbody>
            @foreach($expense_array as $item => $expense)
                <tr>
