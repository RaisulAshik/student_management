								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											@endforeach -->
											<td><a href="{{ route('admin.pdfHomework',$homework->id) }}"  class="mb-xs mt-xs mr-xs btn btn-default" >PDF</a>
										    <a href="{{ route('admin.evaluateHomework',$homework->id) }}"  class="mb-xs mt-xs mr-xs btn btn-default" >Evaluate</a>											</td>
