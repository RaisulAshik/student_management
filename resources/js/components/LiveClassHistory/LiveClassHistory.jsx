...
class LiveClassHistory extends Component {
    ...
    componentDidMount() {
        ...
        if (this.state.student_id == null) {
            axios
                .post(`${Common.api}student/meetings`, {
    ...
    componentDidCatch() {
        console.log("component did catch start");
        console.log(
            "inside componentDidCatch join class and state is",
            this.state
        );
        console.log("component did catch end");
    }

    componentWillUnmount() {
        console.log("component Will Unmount start");
        console.log(
            "inside componentWillUnmount join class and state is",
            this.state
        );
    ...
    componentDidUpdate() {
        ...
        console.log(
            "inside componentDidUpdate join class and student id is",
            this.state.student_id
        );
