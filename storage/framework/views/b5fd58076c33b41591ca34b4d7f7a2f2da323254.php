        ...
        <section class="body-sign">
            <div class="center-sign">
                ...
                <a href="/" class="logo pull-left">
                    <img src="<?php echo e(asset('company/'.$company->logo)); ?>" height="54" alt="Porto Admin" />
                </a>
                        ...
                        <form action="<?php echo e(route('admin.login')); ?>" method="post">
                            ...
                            <div class="form-group mb-lg">
                                ...
                                <div class="input-group input-group-icon">
                                    <input name="email" type="email" value="<?php echo e(old('email')); ?>" class="form-control input-lg" />
...
</html><?php /**PATH /home/codegroover/public_html/student_management/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>