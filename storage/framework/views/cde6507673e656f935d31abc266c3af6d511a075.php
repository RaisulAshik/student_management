...
<body>
    ...
    <div class="company-logo">
        <img height="80px" width="160px" src="<?php echo e(public_path('company/shadowaide1.jpg')); ?>">
    </div>
...
?>
    ...
    <div class="input-field" style="padding-top: -30px !important;">
        <h4>Form No : </h4>
        <p><?php echo e($student->form_number); ?></p>
    </div>
    ...
    <div class="input-field">
        ...
        <p><?php echo e(date('d-m-Y', strtotime($student->date_of_addmission))); ?></p>
    </div>
    ...
    <div class="input-field">
        <h3>Total Amout : </h3>
        <p><?php echo e($student_payment->total_amount); ?> TK</p>
    </div>

    <div class="input-field">
        <h3>Paid Amount : </h3>
        <p><?php echo e($student_payment->paid_amount); ?> TK</p>
    </div>

    <div class="input-field">
        <h3>Due Amount : </h3>
        <p><?php echo e($student_payment->due_amount); ?> TK</p>
    </div>
    ...
    <div class="input-field">
        ...
        <p>
            ...
            <?php else: ?>
                <?php echo e(date('d-m-Y', strtotime($student->next_payment_date))); ?>
    ...
    <div class="signature">
        <h3 style="margin-bottom:0px">Student's Signature</h3>
    </div>

    <div class="signature">
        <h3 style="margin-bottom:0px">Guardian's Signature</h3>
    </div>

    <div class="signature">
        <h3 style="margin-bottom:0px">Authorized Signature</h3>
    </div>
...
<?php /**PATH /home/codegroover/public_html/student_management/resources/views/admin/offline/pdfRegistration.blade.php ENDPATH**/ ?>