   ...
   <header class="page-header">
                     ...
                     <section class="panel">
							...
							<div class="panel-body">
                                <form method="get" action="<?php echo e(action('AdminOnlineStudentController@listSearch')); ?>">
			                    <?php echo csrf_field(); ?>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td><?php echo e($student->form_number); ?></td>
											...
											<td>
												...
												<a href="<?php echo e(route('admin.online_student_registration_pdf',$student->id)); ?>" class="mb-xs mt-xs mr-xs btn btn-sm btn-danger" >Registration Pdf</a>


                                                <?php if($student->next_payment_date == null): ?>
	                                                <form method="post" action="<?php echo e(route('admin.online_student_delete',$student->id)); ?>"  style="display: inline">
	                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegroover/public_html/student_management/resources/views/admin/online/studentList.blade.php ENDPATH**/ ?>