							...
							<div class="panel-body">
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										...
										<tr class="gradeX">
											<td><?php echo e($payment->payment->student->first_name); ?> <?php echo e($payment->payment->student->last_name); ?></td>
											<td><?php echo e($payment->payment->classname->name); ?></td>
											<td><?php echo e($payment->payment->batch->name); ?></td>
											<td><?php echo e($payment->payment->branch->name); ?></td>
											<td><?php echo e($payment->payment->total_amount); ?></td>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegroover/public_html/student_management/resources/views/admin/payment/offlinePaymentList.blade.php ENDPATH**/ ?>