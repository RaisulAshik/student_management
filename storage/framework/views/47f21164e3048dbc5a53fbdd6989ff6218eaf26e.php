   ...
   <header class="page-header">
					...
					<section class="panel">
							...
							<div class="panel-body">
								<form class="" action="<?php echo e(action('AdminMCQExamController@create_mcq_question')); ?>" method="post">
									<?php echo csrf_field(); ?>
...
<script>
       CKEDITOR.replace('editor', {
            ...
            filebrowserUploadUrl: '<?php echo e(route('admin.uploadCqImage', ['_token' => csrf_token() ])); ?>',
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegigz/public_html/student_management/resources/views/admin/mcqExam/mcqQuestionAdd.blade.php ENDPATH**/ ?>