   ...
   <header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Add Teacher Payment</span></li>
							</ol>
					    </div>
					</header>
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Add Teacher Payment</h2>
							</header>
							<div class="panel-body">
								<form action="<?php echo e(route('teachers.createTeacherPaymentInstallment', $teacher->id)); ?>" method="POST" id="formIns">
									<?php echo csrf_field(); ?>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="number" name="" class="form-control" id="total_amount" readonly="true" value="<?php echo e(floor($teacher->afterDiscountAmount)); ?>">
										</div>
									</div>

									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Paid Amount</label>
										<div class="col-md-6">
											<input type="number" name="" class="form-control" id="total_amount" readonly="true" value="<?php echo e(floor($teacher->totalPaid)??0); ?>">
										</div>
									</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="number" name="amount" class="form-control" id="inputDefault">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="payment_date" data-plugin-datepicker class="form-control" id="next_payment_date" value="<?php echo e(now()->toDateString()); ?>">
                                            </div>
                                        </div>
                                    </div>

									<button id="myButtonID" type="submit" class="mb-xs mt-xs mr-xs btn btn-success" onclick="this.disabled=true;this.form.submit();this.value='Submiting...';">Add Payment</button>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\student_management\resources\views/admin/teacher/addTeacherPaymentInstallment.blade.php ENDPATH**/ ?>