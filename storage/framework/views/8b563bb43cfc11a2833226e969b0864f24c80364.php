...
<?php $__env->startSection('content'); ?>
   <header class="page-header">
						<h2> Edit Offline Student Payment</h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Edit Offline Student Payment</span></li>
							</ol>
					    </div>
					</header>
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Edit Offline Student Payment</h2>
							</header>
							<div class="panel-body">
								<form class="" action="<?php echo e(action('AdminOfflineStudentController@update_offline_payment_installment',$payment_installment->id)); ?>" method="post">
									<?php echo csrf_field(); ?>
                                    	...
                                    	<div class="form-group">
											...
											<div class="col-md-6">
												<input type="number" name="paid_amount" class="form-control" id="inputDefault" value="<?php echo e($payment_installment->amount); ?>">
											</div>
										</div>
											
									</div>

									<button type="submit" class="mb-xs mt-xs mr-xs btn btn-success" onclick="this.disabled=true;this.form.submit();this.value='Submiting...';">Edit Payment</button>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegroover/public_html/student_management/resources/views/admin/offline/editOfflinePaymentInstallment.blade.php ENDPATH**/ ?>