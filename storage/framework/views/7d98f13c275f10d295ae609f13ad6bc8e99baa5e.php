...
<body>
        ...
        <table style="width:100%">
            ...
            <?php if(count($d["income"]) > 0): ?>
                ...
                <?php $__currentLoopData = $d["income"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch => $income): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td style="white-space: nowrap; text-align: center;"><?php echo e($batch); ?></td>
                        <td style="white-space: nowrap; text-align: center"><?php echo e($income); ?> Tk</td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                <tr>
                    <th style="white-space: nowrap; text-align: center;">Total Income</th>
                    <th style="white-space: nowrap; text-align: center"><?php echo e($d["total_income"]); ?>
            ...
            <?php if(count($d["expense"]) > 0): ?>
                ...
                <?php $__currentLoopData = $d["expense"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item => $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td style="white-space: nowrap; text-align: center;"><?php echo e($item); ?></td>
                        <td style="white-space: nowrap; text-align: center"><?php echo e($expense); ?> Tk</td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <table style="width:100%">
        ...
        <tr>
            ...
            <td style="white-space: nowrap; text-align: center"><?php echo e($summary['total_days']); ?>
        ...
        <tr>
            ...
            <td style="white-space: nowrap; text-align: center"><?php echo e($summary['all_income']); ?> Tk
            </td>
        </tr>

        <tr>
            <td style="white-space: nowrap; text-align: center;">All Expense</td>
            <td style="white-space: nowrap; text-align: center"><?php echo e($summary['all_expense']); ?> Tk
            </td>
        </tr>

        <tr>
            <td style="white-space: nowrap; text-align: center;">Net Income Summary</td>
            <td style="white-space: nowrap; text-align: center"><?php echo e($summary['all_net_income']); ?>
...
<?php /**PATH /home/codegroover/public_html/student_management/resources/views/admin/report/balancePdf.blade.php ENDPATH**/ ?>