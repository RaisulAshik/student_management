   ...
   <header class="page-header">
					...
					<section class="panel">
							...
							<div class="panel-body">
								<form action="{{ route('teachers.createTeacherPaymentInstallment', $teacher->id) }}" method="POST" id="formIns">
									@csrf
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="number" name="" class="form-control" id="total_amount" readonly="true" value="{{floor($teacher->afterDiscountAmount)}}">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="number" name="" class="form-control" id="total_amount" readonly="true" value="{{floor($teacher->totalPaid)??0}}">
										</div>
									</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="payment_date" data-plugin-datepicker class="form-control" id="next_payment_date" value="{{ now()->toDateString() }}">
                                            </div>
                                        </div>
                                    </div>
