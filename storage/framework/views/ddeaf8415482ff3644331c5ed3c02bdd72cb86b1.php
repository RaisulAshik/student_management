   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Edit Expense</h2>
							</header>
							<div class="panel-body">
								<form class="" action="<?php echo e(action('ExpenseController@update',$expense->id)); ?>" method="post">
									<?php echo csrf_field(); ?>
									...
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Name</label>
											<div class="col-md-6">
												<input type="text" class="form-control" name="name" id="inputDefault" value="<?php echo e($expense->name); ?>">
											</div>
									</div>
                                    <div class="form-group">
										<label class="col-md-2 control-label">Date</label>
										    <div class="col-md-6">
												<div class="input-group">
													...
													<input type="text" name="date" id="date"  data-plugin-datepicker class="form-control" value="<?php echo e($expense->date); ?>">
													</div>
											</div>
									</div>
								    <div class="form-group">
										...
										<div class="col-md-6">
											<select class="form-control mb-md" name="branch_id" id="branch">
												<option value="<?php echo e($expense->branch_id); ?>" selected="true"><?php echo e($expense->branch->name); ?></option>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<select class="form-control mb-md" name="expense_category_id" id="branch">
												<option value="<?php echo e($expense->expense_category_id); ?>" selected="true"><?php echo e($expense->expenseCategory->name??''); ?></option>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="number" name="amount" step=".01" class="form-control" id="inputDefault" value="<?php echo e($expense->amount); ?>">
										</div>
									</div>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegigz/public_html/student_management/resources/views/admin/expense/editExpense.blade.php ENDPATH**/ ?>