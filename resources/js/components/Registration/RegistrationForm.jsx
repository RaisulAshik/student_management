...
class Registration extends Component {
    ...
    handleSubmit(e) {
        ...
        // if (validInputLength === 8 && this.state.canSubmit) {
            ...
            Auth.registration(data).then(res => {
                // console.log(res.data);
                                ...
                                <div className=" text-center input-box">
                                    ...
                                    >
                                        <div className="row">
                                            <div className="col-xs-6 col-sm-6 col-md-6 p-1">
                                                <div className="form-group">
                                                    <input
                                                        ...
                                                        // )}
                                                    />
                                                    {this.validator.message('First name', this.state.first_name, 'required', { className: 'text-danger' })}
                                            ...
                                            <div className="col-xs-6 col-sm-6 col-md-6 p-1">
                                                <div className="form-group">
                                                    ...
                                                    />
                                                    {this.validator.message('Last name', this.state.last_name, 'required', { className: 'text-danger' })}
                                                    {/* {this.state.last_name ? (
                                                        <></>
                                                    ) : (
                                                            <span className="validation-text-error">
                                        ...
                                        <div className="form-group p-1">
                                            ...
                                            />
                                            {this.validator.message('mobile number', this.state.mobileNumber, 'required|min:11', { className: 'text-danger' })}
                                        ...
                                        <div className="row">
                                            <div className="col-6 p-1">
                                                ...
                                                {this.validator.message('choose student type', this.state.std_type, 'required', { className: 'text-danger' })}
                                                {/* {this.state.std_type ? (
                                                    <></>
                                                ) : (
                                                        <span className="validation-text-error">
                                            ...
                                            <div className="col-6 p-1">
                                                ...
                                                {this.validator.message('choose branch', this.state.branch, 'required', { className: 'text-danger' })}
                                                {/* {this.state.branch ? (
                                                    <></>
                                                ) : (
                                                        <span className="validation-text-error">
                                        ...
                                        <div className="row">
                                            <div className="col-6 p-1">
                                                ...
                                                {this.validator.message('choose class', this.state.class, 'required', { className: 'text-danger' })}
                                                {/* {this.state.class ? (
                                                    <></>
                                                ) : (
                                                        <span className="validation-text-error">
                                            ...
                                            <div className="col-6 p-1">
                                                ...
                                                {this.validator.message('choose batch', this.state.batch, 'required', { className: 'text-danger' })}
                                                {/* {this.state.batch ? (
                                                    <></>
                                                ) : (
                                                        <span className="validation-text-error">
