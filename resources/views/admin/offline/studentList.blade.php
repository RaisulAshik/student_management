   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<a class="" href="{{ action('AdminOfflineStudentController@add_student') }}"><i class="fa fa-plus"></i> Add Student
								</a>
								{{-- <a class="" href="{{ action('AdminOfflineStudentController@offline_due_sms') }}"><i class="fa fa-paper-plane"></i> Send Due SMS
								</a> --}}
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td style="">
												...
												<a href="{{ route('admin.offline_student_admit_pdf',$student->id) }}" class="mb-xs mt-xs mr-xs btn btn-sm btn-danger" >Admit Card</a>
