...
Route::group(['prefix' => 'admin', 'middleware' => ['admin']], function () {
    ...
    Route::get('teachers_payment_installment/{id}', 'TeacherController@paymentInstallmentList')->name('teachers.paymentInstallmentList');
    Route::get('add_teachers_payment_installment/{id}', 'TeacherController@addTeacherPaymentInstallment')->name('teachers.addTeacherPaymentInstallment');
    Route::post('create_teachers_payment_installment/{id}', 'TeacherController@createTeacherPaymentInstallment')->name('teachers.createTeacherPaymentInstallment');
