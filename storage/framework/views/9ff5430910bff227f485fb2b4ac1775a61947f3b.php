								...
								<table class="table table-bordered table-striped mb-none" id="">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td><?php echo e($student->obtained_marks); ?></td>
											
											<td><?php echo e($student->merit_position); ?></td>
											<td><?php echo e($student->satisfactory_mark); ?></td>
											<td>
												<a class="mb-xs mt-xs mr-xs btn btn-primary btn-xs" href="<?php echo e(action('AdminExamController@individual_std_exam_result_list',$student->registration_id)); ?>">View All Results</a></td>
											</td>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegroover/public_html/student_management/resources/views/admin/exam/studentList.blade.php ENDPATH**/ ?>