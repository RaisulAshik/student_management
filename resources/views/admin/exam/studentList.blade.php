								...
								<table class="table table-bordered table-striped mb-none" id="">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											{{-- <td>{{$student->highest_marks}}</td> --}}
											<td>{{$student->merit_position}}</td>
											<td>{{$student->satisfactory_mark}}</td>
											<td>
												<a class="mb-xs mt-xs mr-xs btn btn-primary btn-xs" href="{{ action('AdminExamController@individual_std_exam_result_list',$student->registration_id) }}">View All Results</a></td>
											</td>
