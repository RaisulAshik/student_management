    ...
    public function store(Request $request)
    {
        ...
        foreach ($students as $student) {
            ...
            // $sendstatus = $p[0];
                ...
                $number = $student->phone;
                $message=$student->first_name.' '.$student->last_name.' Registration No: '.$student->registration_id.' Total Amount: '.$student->total_amount.' Paid Amount: '.$student->paid_amount.' Due Amount: '.$student->due_amount.' '.$request->message.' - Shadow Aide And Life Line';
