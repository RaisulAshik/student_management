...
class CqExam extends Component {
        ...
        ExamQus.getCqQuestion(data).then(res => {
            ...
            if (this.state.start_time <= this.state.currentTime) {
                ...
                if (endTime[0] == currentTime[0]) {
                    ...
                    let sec = (parseInt(endTime[0]*60)+parseInt(endTime[1])) - (parseInt(currentTime[0]*60)+parseInt(currentTime[1]));
                    let timeLeftVar = this.secondsToTime(sec);
                    this.setState({ time: timeLeftVar });
                } else {
                ...
                return (
                    <div>
                        ...
                        >
                            ...
                            <img src={x} className="imgPreview" style={{ height: "50px" }} />
                        </div>
                    </div>
                );
            } else if (i >= 5 && i <= 10) {
    ...
    handleSubmit(e) {
        ...
        if (this.validator.allValid()) {
            ...
            axios({
                method: "post",
                url: `${Common.api}student/cq_exam_answer_submit`,
                data: formData,
                config: {
                    headers: {
    ...
    answer() {
        return (
            <div className="app-background">
                ...
                {this.validator.message('answer image', this.state.pictures, 'required', { className: 'text-danger' })}
                    ...
                    <div className="">
                        <div className="row">
                            ...
                            <div className="col-md-12">
                                ...
                                {(this.state.final_result == 0 && this.state.timesOut == 0) && (
                                    <div className="app-background">
                                        <div className="row">
                                            <div className="col-md-12 text-right">
                                                <b>
                                                    {" "}
                                                    {this.state.time.m} hours{" "}
                                                    {this.state.time.s} minutes
                                            </b>
                                            </div>
                                        </div>
                                        {allQuestions.map((res, id) => (
                                            <div className="row">
                                                ...
                                                <div className="col-1 col-md-1 pl-0" style={{ float: 'left' }}>{res.mark}</div>
                                            </div>
                                        ))}

                                        <div className="">{this.answer()}</div>
                                    </div>
                                )}
                                {(this.state.final_result == 1 && this.state.timesOut == 0) && (
                                    <div className="app-background">
                                        {/* <div className="row">
                                        ...
                                        <div className="text-center">To see your result please click the button</div>
                                        <div className="text-center">
                                            <button className="btn btn-md btn-success"><Link to={'/cq-result-list'} style={{ color: '#fff' }}>Result</Link></button>
                                        </div>

                                    </div>
                                )}
                                {(this.state.final_result == 0 && this.state.timesOut == 1) && (
                                    
                                    <div className="app-background">
                                        <div className="text-center">Unfortunately!</div>
                                        <div className="text-center">
                                            Your exam has been ended for times out.
                                        </div>
                                        <div className="text-center">To see your result please click the button</div>
                                        <div className="text-center">
                                            <button className="btn btn-md btn-success"><Link to={'/cq-result-list'} style={{ color: '#fff' }}>Result</Link></button>
