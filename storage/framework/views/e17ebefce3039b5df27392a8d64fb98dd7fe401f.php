   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<a class="" href="<?php echo e(action('RoleController@create')); ?>"><i class="fa fa-plus"></i> Add
								</a>
								</div>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td>
												<a href="<?php echo e(route('roles.edit',$role->id)); ?>" class="mb-xs mt-xs mr-xs btn btn-primary" >Edit</a>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegigz/public_html/student_management/resources/views/admin/role/roleList.blade.php ENDPATH**/ ?>