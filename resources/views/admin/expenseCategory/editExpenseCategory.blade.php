   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Edit Expense Group</h2>
							</header>
							<div class="panel-body">
								<form class="" action="{{ action('ExpenseCategoryController@update',$expenseCategory->id)}}" method="post">
									@csrf
									...
									<div class="form-group">
										<label class="col-md-2 control-label" for="inputDefault">Name</label>
											<div class="col-md-6">
												<input type="text" class="form-control" name="name" id="inputDefault" value="{{$expenseCategory->name}}">
											</div>
									</div>
