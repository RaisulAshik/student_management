                            ...
                            <div className="col-md-9">
                                ...
                                <div className="app-background mb-3">
                                    ...
                                    <p className="text-center">
                                        Here you can see all of your MCQ Exam Answer.
                                </p>
                                </div>
                                ...
                                <div className=" text-right">
                                    <button className="btn btn-md btn-success" onClick={this.handleDownload.bind(this)}> download</button>
                                </div>
                            </div>
                        </div>
                    </div>
