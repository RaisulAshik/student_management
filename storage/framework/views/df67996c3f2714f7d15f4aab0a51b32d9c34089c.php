   ...
   <header class="page-header">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<a class="" href="<?php echo e(action('AdminLectureSheetController@create')); ?>"><i class="fa fa-plus"></i> Add
								</a>
								</div>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td><?php echo e($lecture->date); ?></td>
											<td><?php echo e($lecture->branchname->name); ?></td>
											<td><?php echo e($lecture->classname->name); ?></td>
											<td><?php echo e($lecture->batchname->name); ?></td>
											<td><?php echo e($lecture->subjectname->name); ?></td>
											
											<td>
												<a href="<?php echo e(url('/admin/lecture_download')); ?>/<?php echo e($lecture->file); ?>" class="text-success" > <?php echo e($lecture->file); ?></a></td>
											...
											<td>
												...
												<a href="<?php echo e(route('lecture_sheets.edit',$lecture->id)); ?>" class="mb-xs mt-xs mr-xs btn btn-primary" >Edit</a>

												<form method="post" action="<?php echo e(route('lecture_sheets.destroy',$lecture->id)); ?>"  style="display: inline">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codegigz/public_html/student_management/resources/views/admin/lectureSheet/lectureSheetList.blade.php ENDPATH**/ ?>