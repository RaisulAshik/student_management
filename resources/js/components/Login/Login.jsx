...
class Login extends Component {
    ...
    handleSubmit(e) {
        ...
        if (this.state.registrationId == '' || this.state.password == '') {
            this.setState({ error: "please enter your registration Id or password" })
        } else {
            let data = {
                                        ...
                                        <div className="">
                                            ...
                                            <div className="col-xs-12 col-sm-12 col-md-12 p-1">
                                                <div className="form-group">
                                                    ...
                                                    <span className="password_show" onClick={this.handleClick.bind(this)}>{this.state.type === 'text' ? 'Hide' : 'Show'}</span>
                                                </div>
                                            </div>
                                        </div>
